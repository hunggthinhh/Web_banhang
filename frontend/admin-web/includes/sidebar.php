<div class="sidebar">
    ...
    <a href="reviews.php" class="<?php echo (basename($_SERVER['PHP_SELF']) == 'reviews.php') ? 'active' : ''; ?>">Đánh Giá</a>
...
<div class="admin-wrapper">
    <header class="admin-header">
        ...
        <div style="display: flex; align-items: center; gap: 20px;">
            <a href="../store-web/index.php" class="btn btn-view-site" target="_blank">
