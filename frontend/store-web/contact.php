        ...
        <div class="contact-row">
            ...
            <div class="contact-right">
                <p class="form-instruction">
                    Quý khách vui lòng điền thông tin theo mẫu bên dưới. Mọi thắc mắc liên quan đến sản phẩm, dịch vụ,
                    chúng mình <span class="highlight-text">sẽ cố gắng phản hồi trong thời gian sớm nhất.</span>
                </p>
                ...
                <form class="contact-form" action="#" method="POST" id="contactForm">
                    ...
                    <div id="contact-message"
                        style="margin-top: 15px; display: none; padding: 15px; border-radius: 12px; font-family: 'Outfit', sans-serif;">
                    </div>
                </form>
            </div>
        </div>
